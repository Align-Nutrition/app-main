...
export const customTheme: CustomFlowbiteTheme = createTheme({
  button: { inner: { base: twMerge(theme.button.base, "items-center") } },
  checkbox: {
    root: {
      color: {
        default:
  ...
  card: {
    root: {
      base: "flex rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800 flex-col border-none",
